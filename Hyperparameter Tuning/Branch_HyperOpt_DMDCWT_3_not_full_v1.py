...
Rs_path = directory + r'\Rs_FBNN_3.joblib'
Duration_path = directory + r'\Duration_FBNN_3.joblib'
...
V_feeder_CWT_3_not_full_path = directory + r'\V_feeder_DMDCWT_reduced_3_not_full.joblib'
class_path = directory + r'\Branch_Output_sorted_3.joblib'

# Change load file for different dataset
V_feeder_CWT_3 = joblib.load(V_feeder_CWT_3_not_full_path)
Branch_Output_sorted_3 = np.array(joblib.load(class_path))
...
def f_nn(params):
    dataset, output_class = V_feeder_CWT_3, Branch_Output_sorted_3
    ...
    plot_model(model, "Branch_3_ID_training_model.png", show_shapes=True)
...
trainX, testX, trainY, testY, trainRs, testRs, trainDuration, testDuration = shuffle_dataset(V_feeder_CWT_3,
                                                                                             Branch_Output_sorted_3,
                                                                                             Rs, Duration)
...
last_model.summary()
plot_model(last_model, "Branch_3_ID_best_model.png", show_shapes=True)
